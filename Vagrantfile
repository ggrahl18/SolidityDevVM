Vagrant.configure("2") do |config|
  config.vm.define "dapps" do |dapps|
    dapps.vm.box = "b9lab/eth_2019_06_05"
    dapps.vm.box_url = [
      "https://d3mgdk0lg98lr1.cloudfront.net/truffle-vagrant-package-2019-06-05.box",
      "https://b9-academy-assets.s3.amazonaws.com/public/boxes/truffle-vagrant-package-2019-06-05.box",
      "http://localhost:8080/ipfs/QmRX4kPDULh8gZZphL9k2yyVJPXznDJRkLVTQsH2CuSvwB",
      "http://ipfs.b9lab.com:8080/ipfs/QmRX4kPDULh8gZZphL9k2yyVJPXznDJRkLVTQsH2CuSvwB",
      "http://ipfs.io/ipfs/QmRX4kPDULh8gZZphL9k2yyVJPXznDJRkLVTQsH2CuSvwB"
    ]
    config.vm.box_download_checksum = "4c2b12caab660e99a16566132e424e6f7a05c838d6b3bb1ddc421305dee48d1a"
